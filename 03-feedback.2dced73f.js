...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}var r=document.querySelector("input"),a=document.querySelector("textarea"),l=document.querySelector("form"),u="feedback-form-state";l.addEventListener("submit",n),l.addEventListener("input",(0,e.default)(s,500)),i();var o={};function n(e){e.preventDefault(),""!==r.value&&""!==a.value||alert("Please fill required fields"),e.currentTarget.reset(),localStorage.removeItem(u),console.log(o)}function s(e){o.email=r.value,o.message=a.value,localStorage.setItem(u,JSON.stringify(o))}function i(){var e=localStorage.getItem(u),t=JSON.parse(e);t&&t&&(r.value=t.email,a.value=t.message)}
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.2dced73f.js.map