...
"use strict";var e=a(require("lodash/throttle"));function a(e){return e&&e.__esModule?e:{default:e}}var t=document.querySelector(".feedback-form"),l="feedback-form-state";u();var r={email:t.email.value,message:t.message.value};function s(e){var a=e.target,t=a.name,s=a.value;r[t]=s,localStorage.setItem(l,JSON.stringify(r))}function m(e){e.preventDefault();var a={email:e.currentTarget.email.value,message:e.currentTarget.message.value};""!==a.email&&""!==a.message?(console.log(a),localStorage.removeItem(l),t.reset()):alert("Please fill all fields!")}function u(){var e=JSON.parse(localStorage.getItem(l));e&&(e.email&&(t.email.value=e.email),e.message&&(t.message.value=e.message))}t.addEventListener("input",(0,e.default)(s,500)),t.addEventListener("submit",m);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.2663382c.js.map