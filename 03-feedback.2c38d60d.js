...
"use strict";var e=a(require("lodash/throttle"));function a(e){return e&&e.__esModule?e:{default:e}}var t=document.querySelector("form"),l="feedback-form-state";function r(e){e.preventDefault();var a={email:e.currentTarget.email.value,message:e.currentTarget.message.value};""!==a.email&&""!==a.message?(e.currentTarget.reset(),localStorage.removeItem(l),console.log(a)):alert("Please fill all fields!")}function s(){var e={email:t.email.value,message:t.message.value};localStorage.setItem(l,JSON.stringify(e))}function m(){var e=JSON.parse(localStorage.getItem(l));e&&(e.email&&(t.email.value=e.email),e.message&&(t.message.value=e.message))}t.addEventListener("submit",r),t.addEventListener("input",(0,e.default)(s,500)),m();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.2c38d60d.js.map